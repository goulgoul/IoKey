...
#define LORA_RESET GPIO_NUM_12	 // LORA RESET
#define LORA_NSS GPIO_NUM_8	 // LORA SPI CS
#define LORA_SCLK GPIO_NUM_9	 // LORA SPI CLK
#define LORA_MOSI GPIO_NUM_10	 // LORA SPI MOSI
#define LORA_MISO GPIO_NUM_11	 // LORA SPI MISO
#define LORA_BUSY GPIO_NUM_13	 // LORA SPI BUSY
#define LORA_DIO_1 GPIO_NUM_14 // LORA DIO_1
#endif

// Define TTN OTAA keys. All msb (big endian).
uint8_t device_eui[8] = { 0x22, 0x32, 0x33, 0x00, 0x00, 0x88, 0x88, 0x02 };
uint8_t application_eui[8] = { 0x45, 0x43, 0x4f, 0x4c, 0x45, 0x49, 0x4f, 0x45 };
uint8_t application_key[16] = { 0xCE, 0x23, 0x76, 0x27, 0x24, 0x82, 0x78, 0x8C, 0x69, 0x23, 0xED, 0x59, 0x78, 0xDF, 0xF4, 0x5C };
// Foward declaration
...
void setup()
{
	...
	hwConfig.PIN_LORA_DIO_1 = LORA_DIO_1; // LORA DIO_1
	...
	lmh_setAppEui(application_eui);
	lmh_setAppKey(application_key);
	...
	err_code = lmh_init(&lora_callbacks, lora_param_init, doOTAA, CLASS_A, LORAWAN_REGION_IOKEY);
	if (err_code != 0)
	{
