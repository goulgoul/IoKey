...
int RADIO_TXEN = GPIO_NUM_NC;	 // LORA ANTENNA TX ENABLE
int RADIO_RXEN = GPIO_NUM_NC;	 // LORA ANTENNA RX ENABLE
#endif

// Define Helium or TTN OTAA keys. All msb (big endian).
uint8_t nodeDeviceEUI[8] = { 0x22, 0x32, 0x33, 0x00, 0x00, 0x88, 0x88, 0x02 };
uint8_t nodeAppEUI[8] = { 0x45, 0x43, 0x4f, 0x4c, 0x45, 0x49, 0x4f, 0x45 };
uint8_t nodeAppKey[16] = { 0xCE, 0x23, 0x76, 0x27, 0x24, 0x82, 0x78, 0x8C, 0x69, 0x23, 0xED, 0x59, 0x78, 0xDF, 0xF4, 0x5C };
// Foward declaration
